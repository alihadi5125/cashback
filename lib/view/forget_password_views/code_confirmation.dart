...
class _CodeConfirmationState extends State<CodeConfirmation> {
  ...
  Widget build(BuildContext context) {
    MediaQuery.of(context).viewInsets.bottom==0?_scroll.animateTo(0, duration: Duration(milliseconds: 400), curve: Curves.easeIn):
    _scroll.animateTo(500, duration: Duration(milliseconds: 400), curve: Curves.easeIn);
                  ...
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: ListView(
                        ...
                        padding:
                            EdgeInsets.only(left: 20.sp, right: 20.sp, top: 0.1.sh),
                        children: [
                          Image.asset(
                            ...
                            builder: (context, state) {
                              return InkWell(
                                  onTap: () async {
                                   ...
                                   //
                                   // }
                                    Navigator.push(context, MaterialPageRoute(builder: (context)=>SetYourPassword()));
                              ...
                              child: CircularProgressIndicator()
                                  ...
                                  :CustomButton(title: "SEND CONFIRMATION".tr()));
                            },
                          ),
