...
class RetailersSearchModel {
  ...
  final List<RetailersSearchModelDatum> data;


  factory RetailersSearchModel.fromRawJson(String str) => RetailersSearchModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory RetailersSearchModel.fromJson(Map<String, dynamic> json) => RetailersSearchModel(
    data: List<RetailersSearchModelDatum>.from(json["data"].map((x) => RetailersSearchModelDatum.fromJson(x))),
...
class RetailersSearchModelDatum {
  ...
  factory RetailersSearchModelDatum.fromRawJson(String str) => RetailersSearchModelDatum.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory RetailersSearchModelDatum.fromJson(Map<String, dynamic> json) => RetailersSearchModelDatum(
...
class CategoriesDatum {
  ...
  final String uri;
  final String sortNo;
  final List<Sucategory> sucategories;
  ...
  factory CategoriesDatum.fromJson(Map<String, dynamic> json) => CategoriesDatum(
    ...
    uri: json["URI"],
    sortNo: json["sortNo"],
    sucategories: List<Sucategory>.from(json["sucategories"].map((x) => Sucategory.fromJson(x))),
  );
  ...
  Map<String, dynamic> toJson() => {
    ...
    "URI": uri,
    "sortNo": sortNo,
    "sucategories": List<dynamic>.from(sucategories.map((x) => x.toJson())),
  };
}
...
class Sucategory {
  ...
  factory Sucategory.fromRawJson(String str) => Sucategory.fromJson(json.decode(str));
